"""
Base Django settings for Pracxcel Tool - Clinic Practice Intelligence SaaS.
...
# Optional dependencies - add if installed
try:
...
# Django REST Framework (for webhooks)
REST_FRAMEWORK = {
...
# Integration settings (populated from environment)
CLINIKO_API_KEY = os.environ.get('CLINIKO_API_KEY', '')
CLINIKO_SHARD = os.environ.get('CLINIKO_SHARD', 'api')
